  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "absolute w-10 h-10 md:w-14 md:h-14 bg-background/90 backdrop-blur-sm flex items-center justify-center text-foreground hover:bg-background luxury-transition z-10 rounded-full disabled:opacity-50 disabled:pointer-events-none",
